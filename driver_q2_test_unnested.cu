...
int main(int argc, char ** argv){
    ...
    initTable(partsuppTable);
    {
        ...
        // Retrieve the block number from PARTSUPP3
        ...
        for(int i = 0; i < blockTotal; i++){
            ...
            _partsupp_table->attrSize[0] = sizeof(float);
            _partsupp_table->attrIndex[0] = 3;
            _partsupp_table->attrType[0] = FLOAT;
            ...
            _partsupp_table->tupleSize = 0 + sizeof(float) + sizeof(int) + sizeof(int);
...

    {
        ...
        jNode.leftPos[6] = 8;
        jNode.tupleSize += re0_na0_su0_ps0->attrSize[6];
        jNode.rightOutputAttrType = (int *)host_mempool.alloc(sizeof(int)*2);
        jNode.rightOutputIndex = (int *)host_mempool.alloc(sizeof(int)*2);
        jNode.rightPos = (int *)host_mempool.alloc(sizeof(int)*2);
        jNode.rightOutputIndex[0] = 0;
    ...
    initTable(ps1);
    {
        ...
        partsuppTablePartial->attrSize[1] = partsuppTable->attrSize[0];
        partsuppTablePartial->attrIndex[1] = partsuppTable->attrIndex[0];
        partsuppTablePartial->attrType[1] = partsuppTable->attrType[0];
        partsuppTablePartial->dataPos[1] = partsuppTable->dataPos[0];
        partsuppTablePartial->dataFormat[1] = partsuppTable->dataFormat[0];
        partsuppTablePartial->attrTotalSize[1] = partsuppTable->attrTotalSize[0];
        partsuppTablePartial->content[1] = partsuppTable->content[0];
        tuple_size += partsuppTablePartial->attrSize[1];
...

    {
        ...
        jNode.rightPos[1] = 1;
        jNode.tupleSize += ps1->attrSize[1];
        jNode.leftKeyIndex = 0;
        jNode.rightKeyIndex = 2;
        struct tableNode *joinRes;
        int dev_memsize = hashJoinGPUMemSize(&jNode, false);
    ...
    else
    {
        ...
        gbNode->gbExp[0].exp.opValue = 1;
        gbNode->attrType[1] = re1_na1_su1_ps1->attrType[0];
        gbNode->attrSize[1] = re1_na1_su1_ps1->attrSize[0];
        gbNode->tupleSize += re1_na1_su1_ps1->attrSize[0];
    ...
    struct tableNode *sp_gb_re1_na1_su1_ps1;
    {
        ...
        char *free_pos;
        char *free_gpu_pos;
        struct tableNode *gb_re1_na1_su1_ps1SP;
        gb_re1_na1_su1_ps1SP = (struct tableNode *)host_mempool.alloc(sizeof(struct tableNode));
        gb_re1_na1_su1_ps1SP->totalAttr = 2;
        gb_re1_na1_su1_ps1SP->attrType = (int *)host_mempool.alloc(sizeof(int) * 2);
        gb_re1_na1_su1_ps1SP->attrSize = (int *)host_mempool.alloc(sizeof(int) * 2);
        gb_re1_na1_su1_ps1SP->attrIndex = (int *)host_mempool.alloc(sizeof(int) * 2);
        gb_re1_na1_su1_ps1SP->attrTotalSize = (int *)host_mempool.alloc(sizeof(int) * 2);
        gb_re1_na1_su1_ps1SP->dataPos = (int *)host_mempool.alloc(sizeof(int) * 2);
        gb_re1_na1_su1_ps1SP->dataFormat = (int *)host_mempool.alloc(sizeof(int) * 2);
        gb_re1_na1_su1_ps1SP->content = (char **)host_mempool.alloc(sizeof(char *) * 2);
        int tuple_size = 0;
        gb_re1_na1_su1_ps1SP->attrSize[0] = gb_re1_na1_su1_ps1->attrSize[0];
        gb_re1_na1_su1_ps1SP->attrIndex[0] = gb_re1_na1_su1_ps1->attrIndex[0];
        gb_re1_na1_su1_ps1SP->attrType[0] = gb_re1_na1_su1_ps1->attrType[0];
        gb_re1_na1_su1_ps1SP->dataPos[0] = gb_re1_na1_su1_ps1->dataPos[0];
        gb_re1_na1_su1_ps1SP->dataFormat[0] = gb_re1_na1_su1_ps1->dataFormat[0];
        gb_re1_na1_su1_ps1SP->attrTotalSize[0] = gb_re1_na1_su1_ps1->attrTotalSize[0];
        gb_re1_na1_su1_ps1SP->content[0] = gb_re1_na1_su1_ps1->content[0];
        tuple_size += gb_re1_na1_su1_ps1SP->attrSize[0];

        gb_re1_na1_su1_ps1SP->attrSize[1] = gb_re1_na1_su1_ps1->attrSize[1];
        gb_re1_na1_su1_ps1SP->attrIndex[1] = gb_re1_na1_su1_ps1->attrIndex[1];
        gb_re1_na1_su1_ps1SP->attrType[1] = gb_re1_na1_su1_ps1->attrType[1];
        gb_re1_na1_su1_ps1SP->dataPos[1] = gb_re1_na1_su1_ps1->dataPos[1];
        gb_re1_na1_su1_ps1SP->dataFormat[1] = gb_re1_na1_su1_ps1->dataFormat[1];
        gb_re1_na1_su1_ps1SP->attrTotalSize[1] = gb_re1_na1_su1_ps1->attrTotalSize[1];
        gb_re1_na1_su1_ps1SP->content[1] = gb_re1_na1_su1_ps1->content[1];
        tuple_size += gb_re1_na1_su1_ps1SP->attrSize[1];

        gb_re1_na1_su1_ps1SP->tupleSize = tuple_size;
        gb_re1_na1_su1_ps1SP->tupleNum = gb_re1_na1_su1_ps1->tupleNum;

        gb_re1_na1_su1_ps1SP->keepInGpuIdx = 1;
        sp_gb_re1_na1_su1_ps1 = gb_re1_na1_su1_ps1SP;
    }

    // Join two tables: re0_na0_su0_ps0_pa0, sp_gb_re1_na1_su1_ps1
    struct tableNode *re0_na0_su0_ps0_pa0_sp_gb_re1_na1_su1_ps1;

    {
        ...
        jNode.leftOutputAttrType[0] = FLOAT;
        jNode.leftPos[0] = 0;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[0];
        jNode.leftOutputIndex[1] = 1;
        jNode.leftOutputAttrType[1] = STRING;
        jNode.leftPos[1] = 1;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[1];
        jNode.leftOutputIndex[2] = 2;
        jNode.leftOutputAttrType[2] = STRING;
        jNode.leftPos[2] = 2;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[2];
        jNode.leftOutputIndex[3] = 3;
        jNode.leftOutputAttrType[3] = INT;
        jNode.leftPos[3] = 3;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[3];
        jNode.leftOutputIndex[4] = 4;
        jNode.leftOutputAttrType[4] = STRING;
        jNode.leftPos[4] = 4;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[4];
        jNode.leftOutputIndex[5] = 5;
        jNode.leftOutputAttrType[5] = STRING;
        jNode.leftPos[5] = 5;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[5];
        jNode.leftOutputIndex[6] = 6;
        jNode.leftOutputAttrType[6] = STRING;
        jNode.leftPos[6] = 6;
        jNode.tupleSize += re0_na0_su0_ps0_pa0->attrSize[6];
        ...
        // Where conditions: AND(EQ(LEFT.3,RIGHT.1))
        ...
        if(gpu_inner_mp.freesize() < dev_memsize)
            gpu_inner_mp.resize(gpu_inner_mp.usedsize() + dev_memsize);
        char *origin_pos = gpu_inner_mp.freepos();
        re0_na0_su0_ps0_pa0_sp_gb_re1_na1_su1_ps1 = tableScan(&joinRel, &pp, &host_mempool, &gpu_inner_mp, NULL, NULL, NULL, NULL);
        gpu_inner_mp.freeto(origin_pos);
    ...
    result = re0_na0_su0_ps0_pa0_sp_gb_re1_na1_su1_ps1;
    struct materializeNode mn;
    mn.table = result;
    char *final = materializeCol(&mn, &pp);
